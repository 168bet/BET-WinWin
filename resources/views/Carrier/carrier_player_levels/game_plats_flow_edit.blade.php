        ...
        <div class="modal-body" id="modalContent">
            ...
            <div class="row">
                <div class="form-group col-sm-6">
                    ...
                    <select name="rebate_type" class="form-control disable_search_select2" style="width: 100%;">
                ...
                <div class="form-group col-sm-6">
                    ...
                    <select name="rebate_manual_period_hours" class="form-control disable_search_select2" style="width: 100%;">
