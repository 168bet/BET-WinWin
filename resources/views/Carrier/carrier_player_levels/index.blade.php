    ...
    <div class="content">
        ...
        <div class="box box-primary color-palette-box">
            ...
            <div class="box-body">
                ...
                <h5 class="pull-left">
                    <a class="btn btn-primary pull-right" style="margin-top: -10px;margin-bottom: 5px" onclick="{!! TableScript::addOrEditModalShowEventScript(route('carrierPlayerLevels.create')) !!}">新增会员等级</a>
                </h5>
            </div>
