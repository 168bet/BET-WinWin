    ...
    <div class="content">
        ...
        <div class="box box-primary color-palette-box">
            ...
            <div class="box-body">
                ...
                <h5 class="pull-left">
                    <a class="btn btn-primary" style="margin-top: -10px;margin-bottom: 5px" onclick="{!! TableScript::addOrEditModalShowEventScript(route('carrierImages.showUploadImageModal')) !!}">上传素材</a>
