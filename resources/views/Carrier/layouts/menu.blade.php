...
<li class="treeview  {{ Route::is('playerAccountLogs.*','playerDepositPayLogs.*','playerAccountAdjustLogs.*','playerWithdrawFlowLimitLogs.*','playerWithdrawLogs.*','playerDepositPayReviewLogs.*') ? 'active' : '' }}"">
<a href="#">
...
<ul class="treeview-menu">
    ...
    @if(\App\Helpers\Privileges\PrivilegeHelper::instance()->carrierUserHasPrivilege('playerWithdrawLogs.index'))
        ...
        <li class="{{ Route::is('playerWithdrawLogs.*') ? 'active' : '' }}">
    ...
    @if(\App\Helpers\Privileges\PrivilegeHelper::instance()->carrierUserHasPrivilege('playerWithdrawFlowLimitLogs.index'))
        ...
        <li class="{{ Route::is('playerWithdrawFlowLimitLogs.*') ? 'active' : '' }}">
            <a href="{!! route('playerWithdrawFlowLimitLogs.index') !!}"><i
                        class="fa fa-bar-chart"></i><span>流水限制汇总</span></a>
        </li>
    @endif
    {{--<li class="">--}}
    {{--<a href=""><i class="fa fa-list-alt"></i>转账未知处理</a>--}}
    {{--</li>--}}
</ul>
</li>
...
<li class="treeview {{ Route::is('agentAccountAdjustLogs*','carrierAgentDepositPayLogs*','carrierAgentSettleLogs.*','carrierAgentWithdrawLogs.*','carrierAgentSettleHistoryLogs.*') ? 'active' : '' }}">
    <a href="#">
    ...
    <ul class="treeview-menu">
        ...
        <li class="">
            <a href=""><i class="fa fa-money"></i><span>代理存款审核</span></a>
        </li>
...
<li class="treeview {{ Route::is('carrierPlayerNews*','carrierAgentNews*') ? 'active' : '' }}">
    ...
    <ul class="treeview-menu">
        ...
        <li class="">
            <a href=""><i class="fa  fa-comments"></i><span>平台消息</span></a>
        </li>
    </ul>
</li>

<li class="treeview {{ Route::is('carrierWinLoseStastics.*','gameWinLoseStastics.*') ? 'active' : '' }}">
    <a href="#">
    ...
    <ul class="treeview-menu">
        ...
        <li class="">
            <a href=""><i class="fa fa-bar-chart"></i><span>代理输赢报表</span></a>
        </li>
