    ...
    <div class="content">
        ...
        <div class="box box-primary color-palette-box" id="all_player_list">
            ...
            <div class="box-body">
                    ...
                    <h5 class="pull-left">
                        <a class="btn btn-primary pull-right" style="margin-top: -10px;margin-bottom: 5px" onclick="{!! TableScript::addOrEditModalShowEventScript(route('carrierAgentUsers.create')) !!}">新增代理用户</a>
                </h5>
            </div>
