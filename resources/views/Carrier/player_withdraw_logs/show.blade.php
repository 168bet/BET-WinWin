        ...
        <div class="modal-header">
            ...
            <?php
                ...
                foreach($withDrawFlowRecords as $withDrawFlowRecord){
                    if($withDrawFlowRecord->is_finished == false){
                        $unfinishedAmount += $withDrawFlowRecord->limit_amount - $withDrawFlowRecord->complete_limit_amount;
                        if(!$withDrawFlowRecord->game || $withDrawFlowRecord->game->count() == 0){
                            $unfinishedWithPlatAmount += $withDrawFlowRecord->limit_amount - $withDrawFlowRecord->complete_limit_amount;
                        }
                    }
                }
            ?>
