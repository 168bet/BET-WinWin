...
<div class="row">
    <div class="col-sm-4">
        ...
        <div class="form-group col-sm-12">
            {!! Form::label('forbidden_login_comment', '禁止管理员登陆提示原因').Form::required_pin() !!}
    ...
    <div class="col-sm-4">
        ...
        <div class="form-group col-sm-12">
            {!! Form::label('player_forbidden_login_comment', '会员禁止登陆原因') !!}
            {!! Form::text('player_forbidden_login_comment', null, ['class' => 'form-control']) !!}
        </div>
        <div class="form-group col-sm-12">
            {!! Form::label('player_login_failed_count_when_locked', '会员登陆错误几次锁定') !!}
            {!! Form::number('player_login_failed_count_when_locked', null, ['class' => 'form-control']) !!}
        </div>
        <div class="form-group col-sm-12">
            {!! Form::label('player_login_failed_locked_time', '会员登陆错误锁定时间') !!}
    ...
    <div class="col-sm-4">
        ...
        <!-- Atm Deposit Comment Field -->
        <div class="form-group col-sm-12">
            {!! Form::label('agent_forbidden_login_comment', '代理禁止登陆原因') !!}
            {!! Form::text('agent_forbidden_login_comment', null, ['class' => 'form-control']) !!}
        </div>
        <!-- Site Description Field -->
        <div class="form-group col-sm-12">
            {!! Form::label('agent_login_failed_count_when_locked', '代理登陆失败几次锁定') !!}
            {!! Form::text('agent_login_failed_count_when_locked', null, ['class' => 'form-control']) !!}
        </div>
        <div class="form-group col-sm-12">
            {!! Form::label('agent_login_failed_locked_time', '代理登陆失败锁定时间') !!}
