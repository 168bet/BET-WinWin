        ...
        <div class="box box-primary color-palette-box">
            ...
            <div class="box-body">
                ...
                <h5 class="pull-left">
                    ...
                    <a class="btn btn-primary" style="margin-top: -10px;margin-bottom: 5px" onclick="{!! TableScript::addOrEditModalShowEventScript(route('carrierPayChannels.create')) !!}">添加银行账户</a>
                    <a class="btn btn-primary" style="margin-top: -10px;margin-bottom: 5px" onclick="{!! TableScript::addOrEditModalShowEventScript(route('carrierPayChannels.showManualTransferRecordModal')) !!}">手动添加银行转账记录</a>
                </h5>
            </div>
