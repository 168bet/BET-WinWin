<?php $companyDic = \App\Models\Def\PayChannelType::SCAN_CODE_COMPANY_PAY ?>
...
<div class="form-group col-sm-4">
    ...
    <?php $feeBearDic = \App\Models\CarrierPayChannel::feeBearMeta() ?>
...
<div class="form-group col-sm-4">
    ...
    {!! Form::text('fee_ratio', null, ['class' => 'form-control']) !!}
</div>
<div class="form-group col-sm-4">
...
如果设置为1，此时默认比例=1%，假设存款100进入，赠送的存款优惠=100×1%=1" ></i>
    {!! Form::text('default_preferential_ratio', null, ['class' => 'form-control']) !!}
</div>
<div class="form-group col-sm-4">
    {!! Form::label('single_day_deposit_limit','单日存款次数限制').Form::required_pin() !!}
    {!! Form::text('single_day_deposit_limit', null, ['class' => 'form-control']) !!}
</div>
<div class="form-group col-sm-4">
    {!! Form::label('single_deposit_minimum','单次存款最小限额').Form::required_pin() !!}
    {!! Form::text('single_deposit_minimum', null, ['class' => 'form-control']) !!}
</div>
<div class="form-group col-sm-4">
    {!! Form::label('maximum_single_deposit','单次存款最大限额').Form::required_pin() !!}
    {!! Form::text('maximum_single_deposit', null, ['class' => 'form-control']) !!}
</div>
...
<div class="form-group col-sm-3">
    ...
    <i class="fa fa-question-circle" style="color: #f44336"  data-toggle="tooltip" data-original-title="该银行卡的余额达到余额限额提醒时，在客服对会员存款审核的界面上，将提醒该卡余额超限
...
<div class="form-group col-sm-3">
    ...
    <?php $showDic = \App\Models\CarrierPayChannel::showMeta() ?>
...
<div class="form-group col-sm-3">
    ...
    <i class="fa fa-question-circle" style="color: #f44336"  data-toggle="tooltip" data-original-title="1、存款：如果该卡用于存款，则必须选择该项，系统中至少应该有一张用于存款的银行卡
            2、取款：如果该卡用于给会员出款，则必须选择该项
            3、库房：如果该卡既不是存款又不用于取款，则可设为库房
            4、注意：系统不允许同一张银行卡既用于存款又用于取款或者库房" ></i>
    <?php $usePurposeDic = \App\Models\CarrierPayChannel::usedForPurposeMeta(); ?>
    <select name="use_purpose" class="form-control disable_search_select2" style="width: 100%;">
