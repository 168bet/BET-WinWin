...
<main id='main_content'>
    <div class="container">
        ...
        <form class="form-horizontal" role="form" method="post" id="jsForm">
            ...
            <div class="form-group">
                <label for="promotetype" class="col-sm-2 control-label"><span>*</span>推广介绍</label>
                <div class="col-md-10 col-sm-10 col-xs-10">
                    <textarea name="promotion_notion" rows="3" style="width: 200px;color: black;" placeholder="请填写您的推广介绍" required data-rule-introduce='true' data-msg-required='推广介绍必填' data-msg-introduce='推广介绍20-100个字符'></textarea>
                </div>
            </div>
            ...
            <div class="form-group">
                <label for="promotetype" class="col-sm-2 control-label">推广介绍</label>
                <div class="col-md-10 col-sm-10 col-xs-10">
                    <textarea name="promotion_notion" rows="3" style="width: 200px;color: black;" placeholder="请填写您的推广介绍"  data-rule-introduce='true' data-msg-required='推广介绍必填' data-msg-introduce='推广介绍20-100个字符'></textarea>
                </div>
            </div>
            @else
            ...
            <div class="form-group">
                <label for="sponsor" class="col-sm-2 control-label">推荐码</label>
                <div class="col-md-10 col-sm-10 col-xs-10">
                    <input type="text" class="form-control" name="promotion_code" id="sponsor" placeholder="请填写推荐码" minlength='6' maxlength="6" data-rule-number='true' data-msg-minlength='推荐码格式不正确' data-msg-number='推荐码只能是数字'>
                </div>
