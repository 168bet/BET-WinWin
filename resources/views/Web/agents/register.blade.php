    ...
    <div class="container">
        ...
        <form class="form-horizontal" role="form" method="post" id="jsForm">
            ...
            <div class="form-group">
                ...
                <div class="col-md-10 col-sm-10 col-xs-10">
                    <textarea name="promotion_notion" rows="3" style="width: 210px;color: black;" placeholder="请填写您的推广介绍" required data-rule-introduce='true' data-msg-required='推广介绍必填' data-msg-introduce='推广介绍20-100个字符'></textarea>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-10 col-sm-10 col-xs-10">
                    <textarea name="promotion_notion" rows="3" style="width: 210px;color: black;" placeholder="请填写您的推广介绍"  data-rule-introduce='true' data-msg-required='推广介绍必填' data-msg-introduce='推广介绍20-100个字符'></textarea>
                </div>
            </div>
            @else
