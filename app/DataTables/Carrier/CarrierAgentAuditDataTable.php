...
class CarrierAgentAuditDataTable extends DataTable
{
    ...
    {
        $carrierAgentUsers = CarrierAgentUser::with('agentLevel')->select("*")->where('carrier_id','=',\Auth::user()->carrier_id)->where('audit_status','<>',1);
//        $carrierAgentUsers = CarrierAgentUser::with('getAgentLevel')->select("*")->where(['carrier_id' => \Auth::user()->carrier_id,'audit_status'=>0]);
    ...
    private function getColumns()
    {
        return [
            ...
            '代理账号' => ['name' => 'username','data' => 'username','defaultContent' => ''],
            '姓名' => ['name' => 'realname', 'data' => 'realname','defaultContent' => ''],
            ...
            '注册时间' => ['name' => 'created_at', 'data' => 'created_at','orderable' => true],
            '注册IP' => ['name' => 'register_ip', 'data' => 'register_ip','orderable' => true],
            '状态' => ['data' => 'status_name','defaultContent' => ''],
        ];
    }
