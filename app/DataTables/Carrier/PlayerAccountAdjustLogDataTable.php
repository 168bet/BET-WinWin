...
class PlayerAccountAdjustLogDataTable extends DataTable
{
    ...
    public function ajax()
    {
        $DataTables = $this->datatables
            ...
            ->addColumn('adjust_type_string',function(PlayerAccountAdjustLog $log){
    ...
    {
        $playerAccountAdjustLogs = PlayerAccountAdjustLog::with(['player.playerLevel','player.agent','operatorUser' => function($builder){
    ...
    private function getColumns()
    {
        return [
            ...
            '会员等级' => ['name' => 'player.player_level', 'data' => 'player.player_level.level_name','defaultContent' => ''],
            '所属代理' => ['name' => 'player.agent', 'data' => 'player.agent.realname','defaultContent' => '','render' => 'function(){
                if(this.player.agent){
                   return this.player.agent.is_default ? "系统用户" : this.player.agent.realname;
                }
                return null;
            }'],
            '调整类型' => ['name' => 'adjust_type', 'data' => 'adjust_type_string','searchable' => false,'defaultContent' => ''],
            ...
            '操作人' => ['name' => 'operatorUser.username', 'data' => 'operator_user.username','defaultContent' => '']
        ];
    }
