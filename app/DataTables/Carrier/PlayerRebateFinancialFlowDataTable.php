...
class PlayerRebateFinancialFlowDataTable extends DataTable
{
    ...
    public function ajax()
    {
        ...
        $dataTables->addColumn('created_at_format',function(PlayerRebateFinancialFlow $flow){
    ...
    {
        $playerRebateFinancialFlows = PlayerRebateFinancialFlow::orderBy('created_at','desc')->with(['player.playerLevel','player.agent','gamePlat']);
    ...
    {
        return [
            '生成日期' => ['name' => 'created_at','data' => 'created_at_format','searchable' => false],
            ...
            '投注次数' => ['name' => 'bet_times', 'data' => 'bet_times','searchable' => false],
            '有效投注总流水' => ['name' => 'bet_flow_amount', 'data' => 'bet_flow_amount','searchable' => false],
            '派彩总额' => ['name' => 'company_pay_out_amount', 'data' => 'company_pay_out_amount','searchable' => false],
