...
class PlayerDepositPayLogDataTable extends DataTable
{
    ...
    {
        $playerDepositPayLogs = PlayerDepositPayLog::with(['player','carrierPayChannel.payChannel','reviewUser'  => function($builder){
        return $builder->noSuperAdministrator();
    }])->payedSuccessfully()->orderBy('created_at','desc');
...
//            '所属代理' => ['name' => 'player.real_name', 'data' => 'player.real_name','style' => 'text-align:center'],
            '存款金额' => ['name' => 'amount', 'data' => 'amount','style' => 'text-align:center','searchable' => false],
...
//            '取款流水限制' => ['name' => 'withdraw_flow_limit_amount', 'data' => 'withdraw_flow_limit_amount','style' => 'text-align:center','searchable' => false],
            ...
            '操作人' => ['name' => 'review_user_id', 'render' => 'function(){
