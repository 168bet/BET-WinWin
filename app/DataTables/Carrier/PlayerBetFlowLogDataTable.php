...
class PlayerBetFlowLogDataTable extends DataTable
{
    ...
    {
        $playerBetFlowLogs = PlayerBetFlowLog::with(['player','game.gamePlat'])->orderBy('created_at','desc');
    ...
    private function getColumns()
    {
        return [
            ...
            '注单号' => ['name' => 'game_flow_code', 'data' => 'game_flow_code','searchable' => false],
            '游戏平台' => ['name' => 'game_plat_id', 'data' => 'game.game_plat.game_plat_name','searchable' => false],
            '投注内容' => ['name' => 'game_id', 'data' => 'game_name','searchable' => false],
            '投注时间' => ['name' => 'created_at','data' => 'created_at','searchable' => false],
            '投注金额' => ['name' => 'bet_amount', 'data' => 'bet_amount' ,'render' => 'function(){
                return "<span style=\"color: "+ (this.bet_flow_available == false ? "black" : (this.company_win_amount < 0 ? "red" : "green")) +"\">"+this.bet_amount+"<span>"
            }','searchable' => false],
            '派彩金额' => ['name' => 'company_payout_amount', 'data' => 'company_payout_amount','render' => 'function(){
            ...
            '公司输赢' => ['name' => 'company_win_amount', 'data' => 'company_win_amount','render' => 'function(){
            ...
            '有效投注' => ['name' => 'available_bet_amount', 'data' => 'available_bet_amount','render' => 'function(){
            ...
            '结算状态' => ['name' => 'game_status', 'data' => 'game_status','render' => 'function(){
                return this.game_status ? "已结算" : "未结算";
            }','searchable' => false],
            '是否有效' => ['name' => 'bet_flow_available', 'data' => 'bet_flow_available','render' => 'function(){
