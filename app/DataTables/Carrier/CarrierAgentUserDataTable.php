...
//           ->addColumn(['title' => 'intro','data' => null])
    ...
    private function getColumns()
    {
        return [
            ...
            '代理账号' => ['name' => 'username','data' => 'username','orderable' => false],
            '姓名' => ['name' => 'realname', 'data' => 'realname','orderable' => false],
            ...
            '推广码' => ['name' => 'promotion_code', 'data' => 'promotion_code','orderable' => false],
            '注册时间' => ['name' => 'created_at', 'data' => 'created_at','orderable' => false],
            '注册IP' => ['name' => 'register_ip', 'data' => 'register_ip','orderable' => false],
            '客服备注' => ['name' => 'customer_remark', 'data' => 'customer_remark','orderable' => false],
            '状态' => [
                'name' => 'status',
                'render' => 'function(){
