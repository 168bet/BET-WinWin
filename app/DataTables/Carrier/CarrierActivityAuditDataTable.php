...
class CarrierActivityAuditDataTable extends DataTable
{
    ...
    {
        $carrierActivityAudit = CarrierActivityAudit::with(['player.agent','player.playerLevel','activity.actType'])->waitingAudit();
    ...
    private function getColumns()
    {
        return [
            ...
            '活动类型' => ['data' => 'activity.act_type.type_name','orderable' => false],
