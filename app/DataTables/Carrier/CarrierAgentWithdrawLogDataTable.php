...
class CarrierAgentWithdrawLogDataTable extends DataTable
{
    ...
    public function ajax()
    {
        $dataTable = $this->datatables
            ...
            ->addColumn('status_name',function(CarrierAgentWithdrawLog $log){
    ...
    {
        $playerWithdrawLogs = CarrierAgentWithdrawLog::with(['bankCard.bankType','agent','carrierPayChannel.payChannel','operator']);
    ...
    public function html()
    {
        return $this->builder()
            ...
            ->addAction(['width' => '196px','title' => '操作'])
            ->ajax([
    ...
    private function getColumns()
    {
        return [
            ...
            '流水号' => ['name' => 'order_number', 'data' => 'order_number','searchable' => false],
            '账号' => ['name' => 'agent.username', 'data' => 'agent.username','defaultContent' => ''],
            '姓名' => ['name' => 'agent.realname', 'data' => 'agent.realname','defaultContent' => ''],
            '取款金额' => ['name' => 'apply_amount', 'data' => 'apply_amount','searchable' => false],
            '实取金额' => ['name' => 'finally_withdraw_amount', 'data' => 'finally_withdraw_amount','searchable' => false],
            '出款银行' => ['name' => 'carrier_pay_channel','data' => 'carrier_pay_channel.pay_channel.channel_name','defaultContent' => '', 'render' => 'function(){
                return this.carrier_pay_channel ? this.carrier_pay_channel.pay_channel.channel_name : null;
            }','searchable' => false],
            '代理银行卡' => ['name' => 'player_bank_card', 'render' => 'function(){
            ...
            '备注' => ['name' => 'remark', 'render' => 'function(){
            ...
            '申请时间' => ['name' => 'created_at', 'data' => 'created_at','searchable' => false],
            '出款时间' => ['name' => 'withdraw_succeed_at', 'data' => 'withdraw_succeed_at','searchable' => false],
        ];
    }
