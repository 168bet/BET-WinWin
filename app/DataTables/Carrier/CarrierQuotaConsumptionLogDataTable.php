...
class CarrierQuotaConsumptionLogDataTable extends DataTable
{
    ...
    {
        $carrierQuotaConsumptionLogs = CarrierQuotaConsumptionLog::orderBy('created_at','desc')->with('carrierPayChannel.payChannel');
    ...
    {
        return [
            '序号' => ['name' => 'log_id','data' => 'log_id'],
            '支付渠道' => ['name' => 'related_pay_channel', 'data' => 'related_pay_channel','render' => 'function(){
            ...
            '金额' => ['name' => 'amount', 'data' => 'amount'],
            '余额' => ['name' => 'pay_channel_remain_amount', 'data' => 'pay_channel_remain_amount'],
            '明细' => ['name' => 'consumption_source', 'data' => 'consumption_source'],
