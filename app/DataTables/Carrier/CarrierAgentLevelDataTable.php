...
//        $carrierAgentLevels = CarrierAgentLevel::with('defaultPlayerLevel')->select('*')->orderBy('id', 'desc');
        $carrierAgentLevels = CarrierAgentLevel::with('defaultPlayerLevel')->select(['default_player_level','type','sort','level_name','is_default','is_multi_agent','is_running','id'])->where(['carrier_id' => \Auth::user()->carrier_id]);
...
//           ->addColumn(['title' => 'intro','data' => null])
    ...
    private function getColumns()
    {
        return [
            ...
            '代理类型' => ['name' => 'type','data' => 'type_name','orderable' => false,'defaultContent' => ''],
            '代理名称' => ['name' => 'level_name','data' => 'level_name','orderable' => false,],
             '是否支持多级代理' => ['name' => 'is_multi_agent','data' => 'is_multi_agent','orderable' => false, 'render' => 'function(){
                    return this.is_multi_agent == true ? \'是\' : \'否\'
                }'],
            '代理下属默认会员等级' => ['name' => 'level_name','data' => 'default_player_level.level_name','defaultContent' => '','orderable' => false,],
            '是否是默认代理类型' => [
                'name' => 'is_default',
                'data' => 'is_default',
                'orderable' => false,
