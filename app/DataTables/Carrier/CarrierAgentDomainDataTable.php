...
class CarrierAgentDomainDataTable extends DataTable
{
    ...
    {
        $carrierAgentDomains = CarrierAgentDomain::with('agent')->select(['*'])->where(['carrier_id' => \Auth::user()->carrier_id]);
    ...
    private function getColumns()
    {
        return [
            ...
            '代理账号' => ['name' => 'username', 'data' => 'agent.username','defaultContent' => '','orderable' => false,],
            '推广码' => ['name' => 'tgcode', 'data' => 'agent.promotion_code','defaultContent' => '','orderable' => false,],
            '绑定域名' => ['name' => 'website', 'data' => 'website','orderable' => false,],
