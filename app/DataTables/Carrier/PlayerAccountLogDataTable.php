...
class PlayerAccountLogDataTable extends DataTable
{
    ...
    public function ajax()
    {
        $dataTables = $this->datatables
            ->eloquent($this->query())
            ->addColumn('fund_type_name',function($model){
    ...
    {
        $playerAccountLogs = PlayerAccountLog::with(['player','serviceUser' => function($builder){
    ...
    {
        return [
            '序号' => ['defaultContent' => '','searchable' => false],
            ...
            '类型' => ['name' => 'fund_type', 'data' => 'fund_type_name'],
            '来源' => ['name' => 'fund_source', 'data' => 'fund_source'],
            '明细' => ['name' => 'remark', 'data' => 'remark','render' => 'function(){
            ...
            '时间' => ['name' => 'created_at','data' => 'created_at'],
            '操作人' => ['name' => 'operator_reviewer_id','render' => 'function(){
                return this.service_user ? this.service_user.username : null
            }', 'data' => 'service_user.username','searchable' => false]
        ];
    }
