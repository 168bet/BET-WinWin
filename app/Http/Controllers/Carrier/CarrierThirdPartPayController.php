...
class CarrierThirdPartPayController extends AppBaseController
{
    ...
    public function create()
    {
        ...
        $paySub = PayChannelType::where(['parent_id' => $payChannelType['id']])->get();
        foreach ($paySub as $key => $value) {
            $ids[] = $value['id'];
        }
        $payChannelList = \App\Models\Def\PayChannel::whereIn('pay_channel_type_id',$ids)->get();
    ...
    public function edit($id)
    {
        ...
        $payChannelList = \App\Models\Def\PayChannel::whereIn('pay_channel_type_id',$ids)->get();
        return view('Carrier.carrier_third_part_pays.edit')->with(['carrierThirdPartPay'=>$carrierThirdPartPay,'payChannelList'=>$payChannelList]);
    }
    ...
    public function destroy($id)
    {
        ...
        Flash::success('Carrier Third Part Pay deleted successfully.');
