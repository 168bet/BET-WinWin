...
//        $handle->handle();
    ...
    public function synchronizeGameFlowToDB(){
        try{
            ...
            \Log::error('====>同步投注记录失败',['data' =>$e->getMessage()]);
            throw $e;
            dd($e->getMessage());
        }
    }
    ...
    public function gameFlow(){
        try{
            ...
            \Log::error('====>获取投注记录失败',['data' =>$e->getMessage()]);
            dd($e->getMessage());
        }
    ...
    public function playerAccount(){
        try{
            ...
            \Log::error('====>获取会员账户失败',['data' =>$e->getMessage()]);
            dd($e->getMessage());
        }
    }
    ...
    public function userIsOnline(){
        try{
            ...
            \Log::error('====>判断会员是否在线失败',['data' =>$e->getMessage()]);
            dd($e->getMessage());
        }
    ...
    public function depositToPlayerGameAccount(){
        try{
            ...
            \Log::error('====>会员存款到游戏账户失败',['data' =>$e->getMessage()]);
            dd($e->getMessage());
        }
    ...
    public function withDrawFromPlayerGameAccount(){
        try{
            ...
            \Log::error('====>会员从游戏账户取款失败',['data' =>$e->getMessage()]);
            dd($e->getMessage());
        }
    }
