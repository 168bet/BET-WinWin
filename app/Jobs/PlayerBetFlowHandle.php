        ...
        foreach ($this->betFlowRecord as &$record){
            try{
                ...
                do{
                    ...
                    $withdrawFlowLimitWithGameLimit = PlayerWithdrawFlowLimitLog::has('limitGamePlats','>=','1')->byPlayerId($playerGameAccount->player_id)->with('limitGamePlats')->earliestUnfinishedLog()->first();
