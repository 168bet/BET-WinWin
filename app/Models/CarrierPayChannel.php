 ...
 * @property-read \App\Models\Def\PayChannel $payChannel
 * @mixin \Eloquent
...
class CarrierPayChannel extends Model
{
    ...
    public static $rules = [
        ...
        'balance_notify_amount' => 'min:0|integer|required',
        'single_day_deposit_limit' => 'required|integer',
        'single_deposit_minimum' => 'required|integer',
        'maximum_single_deposit' => 'required|integer',
...
//            'account' => 'required|unique:inf_carrier_pay_channel,account,'.$except_id.',id,carrier_id,'.$current_carrier_id.'|alpha_num|max:45'
    ...
    public static function createRules($current_carrier_id){
        return array_merge(self::$rules,[
            'account' => 'required|unique:inf_carrier_pay_channel,account,NULL,NULL,carrier_id,'.$current_carrier_id.'|alpha_num|max:45'
        ]);
    }
