...
class PlayerWithdrawLog extends Model
{
    ...
    public function scopeWithdrawSucceedAtToday(Builder $query){
        return $query->whereBetween('withdraw_succeed_at',[Carbon::now()->startOfDay()->toDateTimeString(),Carbon::now()->endOfDay()->toDateTimeString()]);
    }

    public function scopeWithdrawSucceedBetween(Builder $query,$startTime,$endTime){
        return $query->whereBetween('withdraw_succeed_at',[$startTime,$endTime]);
    }
