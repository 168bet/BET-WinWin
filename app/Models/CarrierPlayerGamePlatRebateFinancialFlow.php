 ...
 * @property-read \App\Models\CarrierPlayerLevel $carrierPlayerLevel
 * @mixin \Eloquent
...
class CarrierPlayerGamePlatRebateFinancialFlow extends Model
{
    ...
    //客服手动洗码周期 1 天
    const REBATE_MANUAL_PERIOD_DAY = 24;// rebate_manual_period_hours
    //客服手动洗码周期 1 周
    ...
    public static function rebateTypeMeta(){
        return [ self::REBATE_TYPE_MANUAL => '客服手动洗码', self::REBATE_TYPE_BY_PLAYER => '会员自助洗码' ];
    }

    public static function rebatePeriodMeta(){
        return [ self::REBATE_MANUAL_PERIOD_DAY => '一天', self::REBATE_MANUAL_PERIOD_WEEK => '一周'];
    }
