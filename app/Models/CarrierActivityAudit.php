...
class CarrierActivityAudit extends Model
{
    ...
    public function scopeJoinedToday(Builder $query){
        return $query->whereBetween('created_at',[Carbon::now()->startOfDay()->toDateTimeString(),Carbon::now()->toDateTimeString()]);
    }

    public function scopeJoinedThisWeek(Builder $query){
        return $query->whereBetween('created_at',[Carbon::now()->startOfWeek()->toDateTimeString(),Carbon::now()->toDateTimeString()]);
    }

    public function scopeJoinedThisMonth(Builder $query){
        return $query->whereBetween('created_at',[Carbon::now()->startOfMonth()->toDateTimeString(),Carbon::now()->toDateTimeString()]);
    }
