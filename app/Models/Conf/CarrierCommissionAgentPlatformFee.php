 ...
 * @property int $agent_rebate_financial_flow_rate 代理洗码比例%
...
class CarrierCommissionAgentPlatformFee extends Model
{
    ...
    const COMMISSION_COMPUTING_MODE = 0;//按佣金计算
    const BET_COMPUTING_MODE = 1;//按有效投注额计算
    ...
    protected $casts = [
        ...
        'agent_rebate_financial_flow_rate' => 'integer',
        'agent_rebate_financial_flow_max_amount' => 'integer',
