 ...
 *
 * @property int $id 运营商登陆注册类设置表
 * @property int $carrier_id 所属运营商
 * @property string $forbidden_login_comment 后台禁止登陆提示原因
 * @property bool $carrier_login_failed_count_when_locked 后台登陆错误导致锁定的次数 0不锁定
 * @property bool $is_allow_player_login 是否允许会员登陆
 * @property bool $is_allow_player_register 是否允许会员注册
 * @property bool $player_login_failed_count_when_locked 会员登陆失败锁定时的错误次数
 * @property string $player_register_forbidden_user_names 会员注册限制账号 逗号分隔多个账号
 * @property string $player_forbidden_login_comment 会员禁止登陆原因
 ...
 * @property bool $is_allow_agent_login 是否允许代理登陆
 * @property bool $is_allow_agent_register 是否允许代理注册
 * @property bool $agent_login_failed_count_when_locked 当代理登陆失败锁定时的登陆次数
 * @property string $agent_register_forbidden_user_names 代理注册禁止注册的账号列表 逗号分隔
 * @property string $agent_forbidden_login_comment 代理禁止登陆原因
...
class CarrierDashLoginConf extends Model
{
    ...
    public static function agentFieldAlias(){
        return [
            ...
            self::AGENT_PROMOTION_IDEA_CONF_STATUS => '推广介绍',
        ];
    }
